...
- `livekit_server_config_turn_deny_peer_cidrs` (default: `[]`) — explicit deny list. Takes precedence over the allow list and applies to all peer CIDRs (including non-restricted ones).
...
LiveKit appears to intentionally only listen on `udp4` and `tcp4` in direct mode, as seen [on this line](https://github.com/livekit/livekit/blob/154b4d26b769c68a03c096124094b97bf61a996f/pkg/service/turn.go#L128) and [this line](https://github.com/livekit/livekit/blob/154b4d26b769c68a03c096124094b97bf61a996f/pkg/service/turn.go#L92) on its source code.
